...
urlpatterns = [
    ...
    path(_('investimenti/aziende/<slug:slug>'), views.BusinessView.as_view(), name='business'),
    path(_('investimenti/oggetti-preziosi/<slug:slug>'), views.PreciousObjectView.as_view(), name='precious'),
    path(_('investimenti/hedge-funds/<slug:slug>'), views.HedgeFundView.as_view(), name='hedge'),
    path(_('investimenti/bonds/<slug:slug>'), views.BondView.as_view(), name='bond'),
    path(_('investimenti/commodities/<slug:slug>'), views.CommodityView.as_view(), name='commodity'),
    path(_('investimenti/equities/<slug:slug>'), views.EquityView.as_view(), name='equity'),
